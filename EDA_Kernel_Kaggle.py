...
def application_train_test(num_rows=None, nan_as_category=False):
    # Read data and merge
    df = pd.read_csv(f'{DATA_FOLDER}/application_train.csv', nrows=num_rows)
...
def bureau_and_balance(num_rows=None, nan_as_category=True):
    bureau = pd.read_csv(f'{DATA_FOLDER}/bureau.csv', nrows=num_rows)
    bb = pd.read_csv(f'{DATA_FOLDER}/bureau_balance.csv', nrows=num_rows)
...
def previous_applications(num_rows=None, nan_as_category=True):
    prev = pd.read_csv(f'{DATA_FOLDER}/previous_application.csv', nrows=num_rows)
...
def pos_cash(num_rows=None, nan_as_category=True):
    pos = pd.read_csv(f'{DATA_FOLDER}/POS_CASH_balance.csv', nrows=num_rows)
...
def installments_payments(num_rows=None, nan_as_category=True):
    ins = pd.read_csv(f'{DATA_FOLDER}/installments_payments.csv', nrows=num_rows)
...
def credit_card_balance(num_rows=None, nan_as_category=True):
    cc = pd.read_csv(f'{DATA_FOLDER}/credit_card_balance.csv', nrows=num_rows)
